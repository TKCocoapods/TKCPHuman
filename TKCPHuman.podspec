...
Pod::Spec.new do |s|
  s.name             = 'TKCPHuman'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKCPHuman.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ZhengXianda/TKCPHuman'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ZhengXianda' => 'xianda.zheng@jiamiantech.com' }
  s.source           = { :git => 'https://github.com/ZhengXianda/TKCPHuman.git', :tag => s.version.to_s }
